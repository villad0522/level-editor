...
import { setupEditor3 } from './003_editor';
...
export function setupEditor2(sections: Array<Section>, onSave: Savefunc) {
    //===============================================================
    // 編集制限の情報を保存する配列
    ...
    //===============================================================
    // エディター初期化
    const editor = setupEditor3(codeAll, () => handleSave(onSave, editor));
    //
    //===============================================================
    // 制約を適用する
